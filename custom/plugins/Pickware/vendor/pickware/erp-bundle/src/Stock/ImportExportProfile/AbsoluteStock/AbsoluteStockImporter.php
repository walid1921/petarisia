...
#[AutoconfigureTag('pickware_erp.import_export.importer', attributes: ['profileTechnicalName' => 'absolute-stock'])]
...
class AbsoluteStockImporter implements Importer
{
    ...
    public function __construct(
        ...
        #[Autowire('%pickware_erp.import_export.profiles.absolute_stock.batch_size%')]
        int $batchSize,
