...
class GoodsReceiptAdditionalInformationProdFeatureFlag extends ProductionFeatureFlag
{
    public const NAME = 'pickware-erp.prod.goods-receipt-additional-information';
