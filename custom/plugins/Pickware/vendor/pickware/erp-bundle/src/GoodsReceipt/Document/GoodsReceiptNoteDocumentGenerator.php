...
class GoodsReceiptNoteDocumentGenerator
{
    public const DOCUMENT_TEMPLATE_FILE = '@PickwareErpBundle/documents/goods-receipt-note.html.twig';
    ...
    public function getFileName(string $localeCode, Context $context): string
    {
        ...
        return sprintf(
            $this->translator->translate('pickware-erp-starter.goods-receipt-note.file-name'),
