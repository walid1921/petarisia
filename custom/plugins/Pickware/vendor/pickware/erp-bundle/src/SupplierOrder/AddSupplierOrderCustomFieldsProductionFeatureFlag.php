...
class AddSupplierOrderCustomFieldsProductionFeatureFlag extends ProductionFeatureFlag
{
    public const NAME = 'pickware-erp.prod.add-supplier-order-custom-fields';
