...
class CreatePartiallyShippedFlowInstallationStep
{
    public const FLOW_ID = '9a1a21d2c5c04522896f4faab0b92bd1';
    ...
    public function install(Context $context): void
    {
        ...
        $createPayload[] = [
            'id' => self::FLOW_ID,
            'eventName' => PartiallyShippedEvent::EVENT_NAME,
            'name' => 'Pickware ERP Partially Shipped',
            'description' => 'Ist dieser Flow aktiviert, wird der Status der Bestellung automatisch auf teilweise versendet gesetzt, wenn die Bestellung teilweise über Pickware ERP versendet wird.',
            'active' => true,
            'sequences' => [
                [
                    'id' => Uuid::randomHex(),
