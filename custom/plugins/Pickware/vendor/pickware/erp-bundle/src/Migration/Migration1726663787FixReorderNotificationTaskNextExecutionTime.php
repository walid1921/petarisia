...
class Migration1726663787FixReorderNotificationTaskNextExecutionTime extends MigrationStep
{
    ...
    public function update(Connection $connection): void
    {
        ...
        $nextExecutionTimeInUTC = (new DateTime('today'))
            ->setTimezone(new DateTimeZone('UTC'))
            ->modify(Json::decodeToArray($systemConfigValue)[ConfigJsonField::STORAGE_KEY]);
