...
class Migration1715685825AddTaxExemptExportLabelDocumentConfig extends MigrationStep
{
    ...
    public function update(Connection $connection): void
    {
        $connection->transactional(function(Connection $transaction): void {
            ...
            $config = Json::decodeToArray($invoiceConfig['config']);
