...
class StocktakeCountingProcessNumberRange extends NumberRange
{
    public const TECHNICAL_NAME = StocktakeCountingProcessDefinition::ENTITY_NAME;

    public function __construct()
    {
        parent::__construct(self::TECHNICAL_NAME, '{n}', 1000, [
            'de-DE' => 'Zählprozesse von Inventuren',
            'en-GB' => 'Stocktake counting processes',
        ]);
    }
}
