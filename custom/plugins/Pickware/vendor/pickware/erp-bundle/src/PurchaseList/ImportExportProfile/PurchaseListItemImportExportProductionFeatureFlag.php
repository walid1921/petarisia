...
class PurchaseListItemImportExportProductionFeatureFlag extends ProductionFeatureFlag
{
    public const NAME = 'pickware-erp.prod.purchase-list-item-import-export';
