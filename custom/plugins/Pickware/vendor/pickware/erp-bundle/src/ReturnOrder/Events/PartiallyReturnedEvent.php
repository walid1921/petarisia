...
class PartiallyReturnedEvent extends Event implements OrderAware, MailAware, FlowEventAware, A11yRenderedDocumentAware
{
    public const EVENT_NAME = 'pickware_erp.order_shipping.partially_returned';
