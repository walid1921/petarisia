...
class PosPaymentCaptureOnOrderTransactionStateSubscriber implements EventSubscriberInterface
{
    ...
    public function orderTransactionWritten(EntityWrittenEvent $event): void
    {
        ...
        foreach ($event->getWriteResults() as $writeResult) {
            ...
            $orderTransaction = $orderTransactions->get((string) $writeResult->getPrimaryKey());
