...
use Pickware\DatevBundle\PaymentCapture\ExternalOrderTransactionCapturedEvent as NewExternalOrderTransactionCapturedEvent;

class_alias(NewExternalOrderTransactionCapturedEvent::class, ExternalOrderTransactionCapturedEvent::class);
...
if (false) {
    ...
    /**
     * @deprecated Removed with version 3.0.0 of the DATEV Bundle. Use NewExternalOrderTransactionCapturedEvent instead.
     */
