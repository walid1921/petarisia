...
class PickingProcessReceiptDocumentGenerator
{
    public const DOCUMENT_TEMPLATE_FILE = '@PickwareWmsBundle/documents/picking-process-receipt.html.twig';
    ...
    public function getFileName(string $localeCode, Context $context): string
    {
        ...
        return sprintf(
            $this->translator->translate('pickware-wms.picking-process-receipt.file-name'),
