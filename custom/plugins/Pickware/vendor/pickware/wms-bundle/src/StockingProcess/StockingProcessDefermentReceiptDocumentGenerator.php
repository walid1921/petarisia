...
class StockingProcessDefermentReceiptDocumentGenerator
{
    public const DOCUMENT_TEMPLATE_FILE = '@PickwareWmsBundle/documents/stocking-process-deferment-receipt.html.twig';
    ...
    public function getFileName(string $localeCode, Context $context): string
    {
        ...
        return sprintf(
            $this->translator->translate('pickware-wms.stocking-process-deferment-receipt.file-name'),
