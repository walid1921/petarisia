 ...
 * Priority 2: Use an empty bin location
 * Priority 3: Use a bin location with the same product
 * Priority 4: Use unknown bin location
 */
class ChaoticWarehousingStockingStrategy extends RoutingStockingStrategy
{
