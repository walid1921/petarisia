...
class PickingStatisticPerformanceAnalysisShippedDeliveriesCalculator extends AbstractPickingStatisticPerformanceAnalysisCalculator
{
    ...
    protected function buildAdditionalWhereConditions(
        ...
        return [
            ...
            'params' => ['eventTechnicalName' => DeliveryLifecycleEventType::Ship->value],
            'types' => [],
        ];
    }
}
