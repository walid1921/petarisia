...
use Pickware\PickwareWms\PickingProcess\Model\PickingProcessCollection;
use Shopware\Core\Framework\DataAbstractionLayer\Entity;
use Shopware\Core\Framework\DataAbstractionLayer\EntityIdTrait;
use Shopware\Core\System\StateMachine\Aggregation\StateMachineState\StateMachineStateEntity;
use Shopware\Core\System\User\UserEntity;

class ShippingProcessEntity extends Entity
{
    use EntityIdTrait;
    ...
    protected ?PickingProcessCollection $pickingProcesses = null;
    ...
    public function getPickingProcesses(): PickingProcessCollection
    {
        if (!$this->pickingProcesses) {
            throw new AssociationNotLoadedException('pickingProcesses', $this);
        }

        return $this->pickingProcesses;
    }

    public function setPickingProcesses(PickingProcessCollection $pickingProcesses): void
    {
        $this->pickingProcesses = $pickingProcesses;
    }
}
