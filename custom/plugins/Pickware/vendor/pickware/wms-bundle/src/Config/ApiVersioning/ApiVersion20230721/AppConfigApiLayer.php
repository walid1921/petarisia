...
namespace Pickware\PickwareWms\Config\ApiVersioning\ApiVersion20230721;
...
class AppConfigApiLayer implements ApiLayer
{
    ...
    public function transformResponse(Request $request, Response $response, Context $context): void
    {
        ...
        $content['shouldCreateShippingLabelUponCompletionOfPicking'] = $content['shippingLabelCreationMode'] !== 'manual';
        unset($content['shippingLabelCreationMode']);
