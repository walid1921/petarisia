...
namespace Pickware\ApiErrorHandlingBundle\TimeoutException;
...
#[WithHttpStatus(Response::HTTP_GATEWAY_TIMEOUT)]
class TimeoutException extends Exception implements JsonApiErrorsSerializable
{
