...
class Migration1710753063CreatePickwarePosOrderLineItemSchema extends MigrationStep
{
    ...
    public function update(Connection $connection): void
    {
        $connection->executeStatement('
            CREATE TABLE IF NOT EXISTS `pickware_pos_order_line_item` (
                ...
                PRIMARY KEY (`id`),
                CONSTRAINT `pickware_pos_order_line_item.fk.order_line_item`
