...
class ReceiptMailTemplate extends MailTemplate
{
    public const TECHNICAL_NAME = 'pickware_pos_receipt';
    ...
    public function __construct()
    {
        parent::__construct(
            self::TECHNICAL_NAME,
            MailTemplateTranslation::loadFromDir(__DIR__ . '/../Resources/mail-templates/receipt'),
            [
                'order' => 'order',
                'shopName' => null,
            ],
