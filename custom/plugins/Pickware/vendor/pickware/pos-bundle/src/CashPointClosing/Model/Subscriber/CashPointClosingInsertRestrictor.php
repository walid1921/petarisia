...
use Pickware\DalBundle\EntityInsertRestrictor;
...
/**
 * An insert restrictor class for all CashPointClosing entities.
 */
class CashPointClosingInsertRestrictor extends EntityInsertRestrictor
{
