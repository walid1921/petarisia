...
class InvoiceLineItemFilterer implements EventSubscriberInterface
{
    public static function getSubscribedEvents(): array
    {
        return [
            InvoiceOrdersEvent::class => 'filterOrderLineItems',
            ZugferdInvoiceOrdersEvent::class => 'filterOrderLineItems',
        ];
    }

    public function filterOrderLineItems(InvoiceOrdersEvent|ZugferdInvoiceOrdersEvent $event): void
    {
