...
class PickwareAustrianPostBundleInstaller
{
    ...
    public function install(Context $context): void
    {
        ...
        $this->carrierInstaller->installCarrier(new AustrianPostCarrier());
    }
    ...
    public function uninstall(Context $context): void
    {
        $this->connection->executeStatement(
            ...
            [
                'domain' => AustrianPostConfig::CONFIG_DOMAIN . '.%',
            ],
        );

        $this->carrierUninstaller->uninstallCarrier(AustrianPostCarrier::TECHNICAL_NAME);
